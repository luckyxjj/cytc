...
<div class="container-fluid">
		...
		<div class="col-lg-9 table-bordered right-bg">
			<form class="form-horizontal" id="update_homeimg_form" method="post"
				action="business/updateBusiness" enctype="multipart/form-data">
				<p class="caption">修改业务范围</p>
				...
				<div class="form-group">
					<label class="col-lg-2 text-right">业务范围描述：</label>
					<div class="col-lg-8">
						<textarea type="text" name="description" rows="2" cols="20"
							class="form-control" maxlength="100"
							data-bv-stringlength-message="长度不能超过100个字符">${business.description}</textarea>
					</div>
				</div>
				
				<div class="form-group id-hide">
					<div class="col-lg-9 col-lg-offset-2">
						<input type="text" name="id" value="${business.id}"
							class="form-control">
					</div>
