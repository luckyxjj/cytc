...
<body>
	<div class="container-fluid">
		...
		<div class="col-lg-9 table-bordered right-bg">
			<form class="form-horizontal" id="add_teacher_form" method="post"
				action="environment/addEnvironment" enctype="multipart/form-data">
				<p class="caption">新增工作环境图</p>

				<div class="form-group">
					<label class="col-lg-2 text-right">选择上传图片： </label>
					<div class="col-lg-9">	
						<div id="del-file" style="float: left;">
							<input type="file" name="environmentFile" style="padding-bottom: 8px;"
	...
	<script type="text/javascript">
		$(document).ready(function() {
			$('#add_teacher_form').bootstrapValidator({
				feedbackIcons : {
