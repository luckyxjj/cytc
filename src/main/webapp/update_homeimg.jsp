...
<body>
	<div class="container-fluid">
		...
		<div class="col-lg-9 table-bordered right-bg">
			<form class="form-horizontal" id="update_homeimg_form" method="post"
				action="homeImg/updateHomeImg" enctype="multipart/form-data">
				<p class="caption">修改主页轮播图片</p>
				...
				<div class="form-group">
					...
					<div class="col-lg-9">
						<input type="text" name="imgUrl" value="${homeImg.imgUrl }"
							class="form-control id-hide" /> <a href="${homeImg.imgUrl }"
							target="_blank"> <img alt="" src="${homeImg.imgUrl }"
							width="100" height="80">
						</a>
						<p>改为：</p>
						<input type="file" name="homeImgFile" maxlength="80"
				...
				<div class="form-group id-hide">
					<div class="col-lg-9 col-lg-offset-2">
						<input type="text" name="id" value="${homeImg.id }"
							class="form-control">
					</div>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			$('#update_homeimg_form').bootstrapValidator({
				feedbackIcons : {
