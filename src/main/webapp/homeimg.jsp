	...
	<div class="container-fluid">
		...
		<div class="col-lg-9 table-bordered right-bg">
			...
			<table
				...
				<caption>
					<p class="title-info">主页图片管理</p>
					
					<a class="add-align btn btn-success " href="add_homeimg.jsp">新增</a>
				</caption>
				...
				<tbody id="member_img_info">
					<c:forEach items="${homeImgList}" var="homeImg" varStatus="status">
						<tr>
							<th scope="row">${status.index + 1}</th>
							<td><a href="${homeImg.imgUrl }" target="_blank"><img src="${homeImg.imgUrl }"  width="80" height="60"></a></td>
							
							<td>${homeImg.createTime }</td>
							<td>${homeImg.updateTime }</td>

							<td><a href="homeImg/getHomeImgById?id=${homeImg.id}"
								class="btn btn-primary"> 修改 </a></td>
							<td>
								<button id="delete" type="button"
									onclick="deleteHomeImg(${homeImg.id })" class="btn btn-primary">删除</button>
							</td>
						</tr>
