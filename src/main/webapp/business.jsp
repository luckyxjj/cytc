...
<div class="container-fluid">
		...
		<div class="col-lg-9 table-bordered right-bg">
			...
			<table
				...
				<caption>
					<p class="title-info">业务范围</p>
					
					<a class="add-align btn btn-success " href="add_business.jsp">新增</a>
				...
				<tbody id="member_img_info">
					<c:forEach items="${businessList}" var="business" varStatus="status">
						...
						<tr>
							...
							<td><a href="business/getBusinessById?id=${business.id}"
								class="btn btn-primary"> 修改 </a></td>
							<td>
								<button id="delete" type="button"
									onclick="deleteBusiness(${business.id})" class="btn btn-primary">删除</button>
							</td>
						</tr>
