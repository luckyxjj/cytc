...
<div class="container-fluid">
		...
		<div class="left-bg col-lg-3">
			...
			<form class="form-horizontal" method="post"
				action="business/addBusiness" enctype="multipart/form-data">
				<p class="caption">新增业务范围</p>

		 	   <div class="form-group">
					<label class="col-lg-2 text-right">选择上传图片： </label>
					<div class="col-lg-9">	
						<div id="del-file" style="float: left;">
							<input type="file" name="businessFile" style="padding-bottom: 8px;"
							 />
						</div>					
				...
				<div class="form-group">
					...
					<div class="col-lg-8">
						<textarea type="text" name="description" rows="2" cols="20"
							...
							data-bv-stringlength-message="长度不能超过100个字符"></textarea>
					</div>
				</div>
